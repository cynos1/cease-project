...
auth.onAuthStateChanged((user)=>{
    if (user){
        ...
        databaseSurvey1ValuesToHTML(user.uid);
    }
    else{
...
function databaseSurvey1ValuesToHTML(user_id){
    console.log(user_id);
...
function HTMLtoDatabaseSurvey1(){
    ...
    return user_module_ref.get().then((doc)=>{
        ...
        user_module.module_1.survey_1.completed = true;
        user_module.module_1.survey_1.questions[0] = slider1_value;
        user_module.module_1.survey_1.questions[1] = slider2_value;
        user_module.module_1.survey_1.questions[2] = slider3_value;
